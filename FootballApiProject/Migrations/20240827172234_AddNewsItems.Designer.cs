...
namespace FootballApiProject.Migrations
{
    ...
    [Migration("20240827172234_AddNewsItems")]
            ...
            modelBuilder.Entity("FootballApiProject.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            AwayTeamId = 2,
                            Date = new DateTime(2024, 8, 26, 19, 22, 33, 714, DateTimeKind.Local).AddTicks(2025),
                            HomeTeamId = 1,
                            Result = 0,
                            Score = "2-1"
                        },
                        new
                        {
                            MatchId = 2,
                            AwayTeamId = 4,
                            Date = new DateTime(2024, 8, 27, 19, 22, 33, 714, DateTimeKind.Local).AddTicks(2115),
                            HomeTeamId = 3,
                            Result = 2,
                            Score = "1-1"
                        },
                        new
                        {
                            MatchId = 3,
                            AwayTeamId = 1,
                            Date = new DateTime(2024, 8, 28, 19, 22, 33, 714, DateTimeKind.Local).AddTicks(2120),
                            HomeTeamId = 5,
                            Score = ""
                        });
                });
            ...
            modelBuilder.Entity("FootballApiProject.Models.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DatePublished = new DateTime(2024, 8, 22, 19, 22, 33, 714, DateTimeKind.Local).AddTicks(2156),
                        ...
                        new
                        {
                            ...
                            DatePublished = new DateTime(2024, 8, 25, 19, 22, 33, 714, DateTimeKind.Local).AddTicks(2162),
