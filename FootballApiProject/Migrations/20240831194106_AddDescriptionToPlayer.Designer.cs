...
namespace FootballApiProject.Migrations
{
    ...
    [Migration("20240831194106_AddDescriptionToPlayer")]
    partial class AddDescriptionToPlayer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FootballApiProject.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            AwayTeamId = 2,
                            Date = new DateTime(2024, 8, 30, 21, 41, 5, 709, DateTimeKind.Local).AddTicks(3525),
                            HomeTeamId = 1,
                            Result = 0,
                            Score = "2-1"
                        },
                        new
                        {
                            MatchId = 2,
                            AwayTeamId = 4,
                            Date = new DateTime(2024, 8, 31, 21, 41, 5, 709, DateTimeKind.Local).AddTicks(3608),
                            HomeTeamId = 3,
                            Result = 2,
                            Score = "1-1"
                        },
                        new
                        {
                            MatchId = 3,
                            AwayTeamId = 1,
                            Date = new DateTime(2024, 9, 1, 21, 41, 5, 709, DateTimeKind.Local).AddTicks(3613),
                            HomeTeamId = 5,
                            Score = ""
                        });
                });
            ...
            modelBuilder.Entity("FootballApiProject.Models.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DatePublished = new DateTime(2024, 8, 26, 21, 41, 5, 709, DateTimeKind.Local).AddTicks(3653),
                        ...
                        new
                        {
                            ...
                            DatePublished = new DateTime(2024, 8, 29, 21, 41, 5, 709, DateTimeKind.Local).AddTicks(3658),
