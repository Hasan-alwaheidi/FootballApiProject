...
namespace FootballApiProject.Migrations
{
    ...
    [Migration("20240822234217_MakeScoreAndResultNullable")]
    partial class MakeScoreAndResultNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FootballApiProject.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            AwayTeamId = 2,
                            Date = new DateTime(2024, 8, 22, 1, 42, 17, 200, DateTimeKind.Local).AddTicks(9069),
                            HomeTeamId = 1,
                            Result = 0,
                            Score = "2-1"
                        },
                        new
                        {
                            MatchId = 2,
                            AwayTeamId = 4,
                            Date = new DateTime(2024, 8, 23, 1, 42, 17, 200, DateTimeKind.Local).AddTicks(9149),
                            HomeTeamId = 3,
                            Result = 2,
                            Score = "1-1"
                        },
                        new
                        {
                            MatchId = 3,
                            AwayTeamId = 1,
                            Date = new DateTime(2024, 8, 24, 1, 42, 17, 200, DateTimeKind.Local).AddTicks(9154),
                            HomeTeamId = 5,
                            Score = ""
                        });
                });
