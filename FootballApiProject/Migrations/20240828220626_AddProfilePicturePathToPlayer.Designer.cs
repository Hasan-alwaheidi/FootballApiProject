...
namespace FootballApiProject.Migrations
{
    ...
    [Migration("20240828220626_AddProfilePicturePathToPlayer")]
    partial class AddProfilePicturePathToPlayer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FootballApiProject.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            AwayTeamId = 2,
                            Date = new DateTime(2024, 8, 28, 0, 6, 25, 106, DateTimeKind.Local).AddTicks(8478),
                            HomeTeamId = 1,
                            Result = 0,
                            Score = "2-1"
                        },
                        new
                        {
                            MatchId = 2,
                            AwayTeamId = 4,
                            Date = new DateTime(2024, 8, 29, 0, 6, 25, 106, DateTimeKind.Local).AddTicks(8550),
                            HomeTeamId = 3,
                            Result = 2,
                            Score = "1-1"
                        },
                        new
                        {
                            MatchId = 3,
                            AwayTeamId = 1,
                            Date = new DateTime(2024, 8, 30, 0, 6, 25, 106, DateTimeKind.Local).AddTicks(8553),
                            HomeTeamId = 5,
                            Score = ""
                        });
                });
            ...
            modelBuilder.Entity("FootballApiProject.Models.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DatePublished = new DateTime(2024, 8, 24, 0, 6, 25, 106, DateTimeKind.Local).AddTicks(8614),
                        ...
                        new
                        {
                            ...
                            DatePublished = new DateTime(2024, 8, 27, 0, 6, 25, 106, DateTimeKind.Local).AddTicks(8618),
