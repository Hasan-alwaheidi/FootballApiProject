...
namespace FootballApiProject.Migrations
{
    ...
    [Migration("20240822114232_UpdateTeamAndStadiumEntities")]
    partial class UpdateTeamAndStadiumEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FootballApiProject.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            AwayTeamId = 2,
                            Date = new DateTime(2024, 8, 21, 13, 42, 31, 361, DateTimeKind.Local).AddTicks(9161),
                            HomeTeamId = 1,
                            Result = 0,
                            Score = "2-1"
                        },
                        new
                        {
                            MatchId = 2,
                            AwayTeamId = 4,
                            Date = new DateTime(2024, 8, 22, 13, 42, 31, 361, DateTimeKind.Local).AddTicks(9308),
                            HomeTeamId = 3,
                            Result = 2,
                            Score = "1-1"
                        },
                        new
                        {
                            MatchId = 3,
                            AwayTeamId = 1,
                            Date = new DateTime(2024, 8, 23, 13, 42, 31, 361, DateTimeKind.Local).AddTicks(9314),
                            HomeTeamId = 5,
                            Score = ""
                        });
                });
