...
namespace FootballApiProject.Migrations
{
    ...
    [Migration("20240823082845_MakeScoreAndeResultNull")]
    partial class MakeScoreAndeResultNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FootballApiProject.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            AwayTeamId = 2,
                            Date = new DateTime(2024, 8, 22, 10, 28, 45, 388, DateTimeKind.Local).AddTicks(4658),
                            HomeTeamId = 1,
                            Result = 0,
                            Score = "2-1"
                        },
                        new
                        {
                            MatchId = 2,
                            AwayTeamId = 4,
                            Date = new DateTime(2024, 8, 23, 10, 28, 45, 388, DateTimeKind.Local).AddTicks(4726),
                            HomeTeamId = 3,
                            Result = 2,
                            Score = "1-1"
                        },
                        new
                        {
                            MatchId = 3,
                            AwayTeamId = 1,
                            Date = new DateTime(2024, 8, 24, 10, 28, 45, 388, DateTimeKind.Local).AddTicks(4729),
                            HomeTeamId = 5,
                            Score = ""
                        });
                });
