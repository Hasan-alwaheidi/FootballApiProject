...
namespace FootballApiProject.Migrations
{
    ...
    [Migration("20240817202358_AddStadiumTeamsRelationship")]
    partial class AddStadiumTeamsRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FootballApiProject.Models.Match", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MatchId = 1,
                            AwayTeamId = 2,
                            Date = new DateTime(2024, 8, 16, 22, 23, 57, 815, DateTimeKind.Local).AddTicks(4666),
                            HomeTeamId = 1,
                            Result = 0,
                            Score = "2-1"
                        },
                        new
                        {
                            MatchId = 2,
                            AwayTeamId = 4,
                            Date = new DateTime(2024, 8, 17, 22, 23, 57, 815, DateTimeKind.Local).AddTicks(4722),
                            HomeTeamId = 3,
                            Result = 2,
                            Score = "1-1"
                        },
                        new
                        {
                            MatchId = 3,
                            AwayTeamId = 1,
                            Date = new DateTime(2024, 8, 18, 22, 23, 57, 815, DateTimeKind.Local).AddTicks(4725),
                            HomeTeamId = 5,
                            Score = ""
                        });
                });
